        ...
        <div ref={ref} className="hb-reveal" style={{ display: 'grid', gridTemplateColumns: '3fr 2fr', gap: 1, background: 'var(--hb-rule)' }}>
          ...
          <div style={{ background: 'var(--hb-bg)', padding: 48 }}>
            ...
            <p style={{ fontFamily: 'var(--hb-sans)', fontSize: 14, lineHeight: 1.7, color: 'var(--hb-ink-dim)', maxWidth: 520, margin: 0 }}>
              Прошёл путь от монтажника до управляющего партнёра. 12 лет на стройке — знает каждый узел изнутри. Лично контролирует каждый объект студии. Убеждён, что репутацию строят скрытые работы, а не фасад.
            </p>
          </div>
          ...
          <div style={{ background: 'var(--hb-bg)', padding: 48 }}>
            ...
            <p style={{ fontFamily: 'var(--hb-sans)', fontSize: 14, lineHeight: 1.7, color: 'var(--hb-ink-dim)', margin: 0 }}>
              Главный дизайнер студии. Окончила СПбГАСУ. Специализируется на жилых интерьерах класса бизнес и премиум. Её проекты — это точный баланс между эстетикой и практичностью жизни.
            </p>
          </div>
        </div>
      </div>
